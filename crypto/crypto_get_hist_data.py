...
# TODO:
#   download tickers as JSON array
#   create function: get_hist_all (vexchange, vtickers, vtimeframe='1m')
#   run functions
#   automate find tickers with greatest change % since day star
#   backtest on selected tickers
