...
# in order to download historical data. Currently this is just holding code
# that will be moved out soon.
...
class CryptoHistory:
    """Use CCXT lib to retrieve data on tickers, i.e. historical data used 
    to backtest strategies."""

    def to_unix_time (self, timestamp):
        """Convert a ccxt timestamp into readable format."""
    ...
    def gen_hist_data ():
        """Download historical data as JSON."""
